...
if((player_one_selection == "rock" and player_two_selection == "sizors") 
or (player_one_selection == "paper" and player_two_selection == "rock")
or (player_one_selection ==  "sizors" and player_two_selection == "paper")):
    print("{0} beats {1} {2} Wins!".format(player_one_selection,player_two_selection,player_one))

if((player_two_selection == "rock" and player_one_selection == "sizors") 
or (player_two_selection == "paper" and player_one_selection == "rock")
or (player_two_selection ==  "sizors" and player_one_selection == "paper")):
